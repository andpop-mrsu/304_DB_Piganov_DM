DROP TABLE IF EXISTS worker_schedule;        -- НОВАЯ ТАБЛИЦА
...
-- НОВАЯ ТАБЛИЦА: График работы мастеров (шаблон)
...
-- Пример расписания для мастеров (НОВЫЕ ДАННЫЕ)
INSERT INTO worker_schedule (worker_id, day_of_week, start_time, end_time, is_active) VALUES
(1, 1, '09:00', '18:00', 1), -- Иванов: Пн
(1, 2, '09:00', '18:00', 1), -- Вт
(1, 3, '09:00', '18:00', 1), -- Ср
(1, 4, '09:00', '18:00', 1), -- Чт
(1, 5, '09:00', '18:00', 1), -- Пт
(1, 6, '10:00', '16:00', 1), -- Сб
(2, 1, '08:00', '17:00', 1), -- Петров: Пн
(2, 2, '08:00', '17:00', 1),
(2, 3, '08:00', '17:00', 1),
(2, 4, '08:00', '17:00', 1),
(2, 5, '08:00', '17:00', 1),
(3, 2, '10:00', '19:00', 1), -- Сидорова: работает только Вт-Сб
(3, 3, '10:00', '19:00', 1),
(3, 4, '10:00', '19:00', 1),
(3, 5, '10:00', '19:00', 1),
(3, 6, '10:00', '19:00', 1);